...
private String baseDirectory;
 ...
 private void setupDefaultRules(){
       ...
       // Rules using OrganizationRule objects//
         ...
         organizationRules.add(new OrganizationRule(".mp4", "videos"));
         organizationRules.add(new OrganizationRule(".avi", "videos"));
         organizationRules.add(new OrganizationRule(".mov", "videos"));
         organizationRules.add(new OrganizationRule(".wmv", "videos"));
